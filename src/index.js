...
.pillar-card h3 { font-size: 22px; font-weight: 700; color: var(--ink); margin-bottom: 12px; text-align: center; }
.pillar-card p { font-size: 15px; color: var(--muted-2); line-height: 1.75; text-align: center; }
...
.loop-track { position: relative; max-width: 1060px; margin: 0 auto; background: var(--ink); border-radius: 20px; padding: 40px 32px; box-shadow: 0 20px 60px rgba(0,0,0,0.12); }
...
.lc { background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.08); border-radius: 6px; padding: 22px 20px 18px; transition: box-shadow 0.3s ease, transform 0.3s ease; cursor: default; display: flex; flex-direction: column; }
.lc:hover { box-shadow: 0 8px 28px rgba(46,168,74,0.06); transform: translateY(-2px); background: rgba(255,255,255,0.06); }
.lc-top { display: flex; align-items: center; gap: 12px; margin-bottom: 10px; }
.lc-ico { width: 42px; height: 42px; min-width: 42px; border-radius: 50%; background: rgba(46,168,74,0.08); border: 1.5px solid rgba(46,168,74,0.2); display: flex; align-items: center; justify-content: center; position: relative; }
...
.lc-top h4 { font-size: 15px; font-weight: 700; color: var(--white); line-height: 1.25; }
.lc > p { font-size: 13px; color: rgba(255,255,255,0.45); line-height: 1.65; flex: 1; }
.lc-tag { display: inline-block; font-size: 9px; font-weight: 700; letter-spacing: 0.14em; text-transform: uppercase; color: var(--green-accent, #46c461); background: rgba(46,168,74,0.1); padding: 3px 9px; border-radius: 2px; margin-top: 9px; }
...
.loop-mobile-wrap { display: none; background: var(--ink); border-radius: 20px; padding: 32px 24px; box-shadow: 0 20px 60px rgba(0,0,0,0.12); }
.loop-mobile { position: relative; max-width: 500px; margin: 0 auto; padding-left: 42px; }
...
.mi-body h4 { font-size: 15px; font-weight: 700; color: var(--white); margin-bottom: 4px; line-height: 1.3; }
.mi-body p { font-size: 13.5px; color: rgba(255,255,255,0.5); line-height: 1.65; }
...
@media (max-width: 960px) {
  ...
  .loop-mobile-wrap { display: block !important; }
    ...
    <div class="pillars-grid">
      <div class="pillar-card nutrition reveal-scale d1">
        <div class="pillar-visual">
          <svg width="44" height="44" viewBox="0 0 24 24" fill="none" stroke="#39BA76" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
            <path d="M3 2v7c0 1.1.9 2 2 2h4a2 2 0 002-2V2"/><path d="M7 2v20"/><path d="M21 15V2v0a5 5 0 00-5 5v6c0 1.1.9 2 2 2h3zm0 0v7"/>
          </svg>
        </div>
        <h3>Nutrition</h3>
        <p>What you eat shapes everything. TLC tracks every meal, macro, and pattern, then shows you exactly how food drives your energy, recovery, and long-term health outcomes.</p>
      </div>
      <div class="pillar-card body-pillar reveal-scale d2">
        <div class="pillar-visual">
          <svg width="44" height="44" viewBox="0 0 24 24" fill="none" stroke="#398CBA" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
            <circle cx="12" cy="8" r="4"/><path d="M4 20c0-4 3.6-7 8-7s8 3 8 7"/>
          </svg>
        </div>
        <h3>Body</h3>
        <p>Sleep, recovery, HRV, strain. 25+ wearables feed your real biometric data directly into every insight, so your plan adapts to what your body is actually doing, not a generic formula.</p>
      </div>
      <div class="pillar-card mind reveal-scale d3">
        <div class="pillar-visual">
          <!-- Brain (Lucide) -->
          <svg width="44" height="44" viewBox="0 0 24 24" fill="none" stroke="#E8B84B" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
            <path d="M9.5 2A2.5 2.5 0 0 1 12 4.5v15a2.5 2.5 0 0 1-4.96-.44 2.5 2.5 0 0 1-2.96-3.08 3 3 0 0 1-.34-5.58 2.5 2.5 0 0 1 1.32-4.24 2.5 2.5 0 0 1 1.98-3A2.5 2.5 0 0 1 9.5 2Z"/>
            <path d="M14.5 2A2.5 2.5 0 0 0 12 4.5v15a2.5 2.5 0 0 0 4.96-.44 2.5 2.5 0 0 0 2.96-3.08 3 3 0 0 0 .34-5.58 2.5 2.5 0 0 0-1.32-4.24 2.5 2.5 0 0 0-1.98-3A2.5 2.5 0 0 0 14.5 2Z"/>
          </svg>
        </div>
        <h3>Mind</h3>
        <p>Mood, stress, focus, and energy. A 60-second daily reflection captures what wearables miss. TLC finds the link between how you feel today and what you ate, did, or skipped yesterday.</p>
      </div>
    </div>
