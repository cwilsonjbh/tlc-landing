...
<!-- THE OBVIOUS SECRET -->
<section style="padding:clamp(80px,10vw,140px) 0;background:var(--ink);position:relative;z-index:2;overflow:hidden;">
  <!-- subtle nebula radial -->
  <div style="position:absolute;inset:0;background:radial-gradient(ellipse 80% 60% at 50% 100%,rgba(46,168,74,0.07) 0%,transparent 70%);pointer-events:none;"></div>
  <div class="container" style="position:relative;z-index:1;text-align:center;">
    <span class="label" style="justify-content:center;margin-bottom:24px;display:inline-flex;color:rgba(255,255,255,0.45);background:transparent;border:none;letter-spacing:0.22em;">The Obvious Secret</span>
    <h2 style="font-family:var(--font-display);font-size:clamp(44px,6vw,84px);line-height:0.95;letter-spacing:0.02em;color:var(--white);margin-bottom:40px;" class="reveal">YOUR MIND KNEW.<br>YOUR BODY KNEW.<br>YOUR WEARABLE KNEW.<br><em style="font-style:normal;color:var(--green-accent);">NOBODY CONNECTED THEM.</em></h2>
    <p style="font-size:clamp(16px,1.6vw,19px);color:rgba(255,255,255,0.62);line-height:1.8;max-width:580px;margin:0 auto 52px;font-weight:300;" class="reveal d1">Your wearable has been tracking your sleep for years. Your food app has logged thousands of meals. Your energy, mood, and focus have risen and fallen in patterns nobody ever explained. The data was never the problem. It was always there, sitting in three separate places, waiting for someone to put it together.</p>
    <!-- Pull quote -->
    <div style="border-left:3px solid var(--green);padding:0 0 0 28px;max-width:560px;margin:0 auto 52px;text-align:left;" class="reveal d2">
      <p style="font-size:clamp(19px,2vw,26px);color:var(--white);font-weight:600;line-height:1.5;margin:0;">"The data was never the problem. It was always there. Nobody connected it until now."</p>
    </div>
    <!-- Three dots visual echo -->
    <div style="display:flex;align-items:center;justify-content:center;gap:12px;margin-bottom:48px;" class="reveal d3">
      <div style="display:flex;align-items:center;gap:8px;padding:10px 18px;border-radius:999px;border:1px solid rgba(57,186,118,0.3);background:rgba(57,186,118,0.07);">
        <div style="width:8px;height:8px;border-radius:50%;background:#39BA76;"></div>
        <span style="font-size:11px;font-weight:700;letter-spacing:0.14em;text-transform:uppercase;color:rgba(57,186,118,0.85);">Nutrition</span>
      </div>
      <svg width="20" height="12" viewBox="0 0 20 12" fill="none"><path d="M0 6 L18 6 M14 2 L18 6 L14 10" stroke="rgba(255,255,255,0.2)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
      <div style="display:flex;align-items:center;gap:8px;padding:10px 18px;border-radius:999px;border:1px solid rgba(57,140,186,0.3);background:rgba(57,140,186,0.07);">
        <div style="width:8px;height:8px;border-radius:50%;background:#398CBA;"></div>
        <span style="font-size:11px;font-weight:700;letter-spacing:0.14em;text-transform:uppercase;color:rgba(57,140,186,0.85);">Body</span>
      </div>
      <svg width="20" height="12" viewBox="0 0 20 12" fill="none"><path d="M0 6 L18 6 M14 2 L18 6 L14 10" stroke="rgba(255,255,255,0.2)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
      <div style="display:flex;align-items:center;gap:8px;padding:10px 18px;border-radius:999px;border:1px solid rgba(232,184,75,0.3);background:rgba(232,184,75,0.07);">
        <div style="width:8px;height:8px;border-radius:50%;background:#E8B84B;"></div>
        <span style="font-size:11px;font-weight:700;letter-spacing:0.14em;text-transform:uppercase;color:rgba(232,184,75,0.85);">Mind</span>
      </div>
      <svg width="20" height="12" viewBox="0 0 20 12" fill="none"><path d="M0 6 L18 6 M14 2 L18 6 L14 10" stroke="rgba(255,255,255,0.2)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
      <div style="display:flex;align-items:center;gap:8px;padding:10px 18px;border-radius:999px;border:1px solid rgba(46,168,74,0.45);background:rgba(46,168,74,0.12);">
        <div style="width:8px;height:8px;border-radius:50%;background:#2ea84a;"></div>
        <span style="font-size:11px;font-weight:700;letter-spacing:0.14em;text-transform:uppercase;color:rgba(70,196,97,0.9);">TLC</span>
      </div>
    </div>
    <p style="font-size:13px;font-weight:700;letter-spacing:0.16em;text-transform:uppercase;color:rgba(255,255,255,0.28);" class="reveal d3">Three pillars. One picture. Finally.</p>
  </div>
</section>
