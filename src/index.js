...
.teaser-tier { display: inline-flex; align-items: center; font-size: 10px; font-weight: 800; letter-spacing: 0.10em; text-transform: uppercase; border-radius: 50px; padding: 4px 12px; margin-bottom: 16px; width: fit-content; }
.teaser-card.tc-di .teaser-tier, .teaser-card.tc-coach .teaser-tier { background: rgba(46,168,74,0.08); color: var(--green); border: 1px solid rgba(46,168,74,0.20); }
.teaser-card.tc-mm .teaser-tier { background: rgba(26,26,26,0.04); color: var(--muted-2); border: 1px solid var(--border-mid); }
  ...
  <div class="container">
    ...
    <div class="teasers-grid">
      ...
      <a href="/features#dynamic-insights" class="teaser-card tc-di reveal d1">
        ...
        <div class="teaser-tier">TLC &middot; $9.99/mo</div>
      ...
      <a href="/features#meal-matchmaker" class="teaser-card tc-mm reveal d2">
        ...
        <div class="teaser-tier">TLC Lite &middot; Free forever</div>
