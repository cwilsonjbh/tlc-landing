...
<section style="padding:clamp(80px,10vw,140px) 0;background:var(--ink);position:relative;z-index:2;overflow:hidden;">
  ...
  <div class="container" style="position:relative;z-index:1;text-align:center;">
    ...
    <h2 style="font-family:var(--font-display);font-size:clamp(44px,6vw,84px);line-height:0.95;letter-spacing:0.02em;color:var(--white);margin-bottom:40px;" class="reveal">YOUR WEARABLE KNEW.<br>YOUR MEALS KNEW.<br><em style="font-style:normal;color:var(--green-accent);">NOBODY CONNECTED THEM.</em></h2>
