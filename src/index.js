...
<section class="section-features" id="features">
  ...
  <div class="feature-block"><div class="container"><div class="feature-inner">
    ...
    <div class="feature-copy reveal d2">
      ...
      <ul class="feature-highlights">
        <li>28-day meal plan tailored to goals, tastes, and restrictions</li>
        <li>Smart zero-waste shopping list across all meals</li>
        <li>10&ndash;15% average monthly grocery saving</li>
        <li>Adapts weekly as your goals and biometrics evolve</li>
      </ul>
      <a href="mailto:chris@thelongevitychef.com" class="feature-cta">Join the Pro waitlist &rarr;</a>
    </div>
  </div></div></div>
