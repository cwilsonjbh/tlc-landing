...
(function setupThreadBackdrop() {
  ...
  var MONA_URL = 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6a/Mona_Lisa.jpg/960px-Mona_Lisa.jpg?utm_source=commons.wikimedia.org&utm_campaign=index&utm_content=thumbnail';
  var img = new Image();
  var imgReady = false;
  ...
  function play(idx) {
    ...
    script.turns.forEach(function(turn) {
      if (turn.role === 'user') {
        ...
        })(delay, reduced ? 0 : delay + 1700, turn.html);
        delay = reduced ? 0 : delay + 1700 + 1400;
      }
    });
  }
