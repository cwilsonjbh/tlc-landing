...
<section style="padding:clamp(72px,9vw,120px) 0;background:var(--surface);border-top:1px solid var(--border);border-bottom:1px solid var(--border);position:relative;z-index:2;">
  <div class="container">
    <div style="text-align:center;margin-bottom:52px;" class="reveal">
      ...
      <h2 style="font-family:var(--font-display);font-size:clamp(36px,4.5vw,60px);line-height:0.95;letter-spacing:0.02em;color:var(--ink);">YOUR BODY IS A PRECISION ENGINE.<br><em style="font-style:normal;color:var(--green);">THE PARTS JUST NEED CONNECTING.</em></h2>
    </div>
    <div style="display:grid;grid-template-columns:1fr auto 1fr auto 1fr;gap:16px;align-items:center;max-width:960px;margin:0 auto;" class="reveal d1">

      <div style="background:var(--white);border:1.5px solid var(--border-mid);border-radius:16px;padding:32px 24px;text-align:center;">
        <div style="width:56px;height:56px;border-radius:16px;background:rgba(57,140,186,0.10);display:flex;align-items:center;justify-content:center;margin:0 auto 18px;">
          <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#398CBA" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>
        </div>
        <div style="font-size:10px;font-weight:800;letter-spacing:0.18em;text-transform:uppercase;color:var(--body-blue);margin-bottom:8px;">Wearables</div>
        <div style="font-family:var(--font-display);font-size:clamp(22px,2.5vw,30px);line-height:1;letter-spacing:0.02em;color:var(--ink);margin-bottom:10px;">THE DASHBOARD</div>
        <p style="font-size:13px;color:var(--muted-2);line-height:1.65;">HRV, sleep stages, resting heart rate. Hundreds of data points — and without context, they do not clarify. They overwhelm.</p>
      </div>

      <div style="font-family:var(--font-display);font-size:clamp(28px,3vw,40px);color:var(--muted);text-align:center;flex-shrink:0;">+</div>

      <div style="background:var(--white);border:1.5px solid var(--border-mid);border-radius:16px;padding:32px 24px;text-align:center;">
        <div style="width:56px;height:56px;border-radius:16px;background:rgba(57,186,118,0.10);display:flex;align-items:center;justify-content:center;margin:0 auto 18px;">
          <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#39BA76" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 2v7c0 1.1.9 2 2 2h4a2 2 0 002-2V2"/><path d="M7 2v20"/><path d="M21 15V2"/><path d="M18 15a3 3 0 100 6 3 3 0 000-6z"/></svg>
        </div>
        ...
        <div style="font-family:var(--font-display);font-size:clamp(22px,2.5vw,30px);line-height:1;letter-spacing:0.02em;color:var(--ink);margin-bottom:10px;">THE FUEL</div>
        <p style="font-size:13px;color:var(--muted-2);line-height:1.65;">Every meal is a signal your body responds to. But tracked in isolation, it is just a number with nowhere to go.</p>
      </div>

      <div style="font-family:var(--font-display);font-size:clamp(28px,3vw,40px);color:var(--muted);text-align:center;flex-shrink:0;">=</div>

      <div style="background:linear-gradient(160deg,rgba(46,168,74,0.06) 0%,rgba(255,255,255,0) 60%);border:1.5px solid rgba(46,168,74,0.22);border-radius:16px;padding:32px 24px;text-align:center;position:relative;">
        <div style="width:56px;height:56px;border-radius:16px;background:rgba(46,168,74,0.12);display:flex;align-items:center;justify-content:center;margin:0 auto 18px;">
          <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#2ea84a" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polygon points="12 8 15.09 14.26 22 15.27 17 20.14 18.18 27.02 12 23.77 5.82 27.02 7 20.14 2 15.27 8.91 14.26 12 8"/><path d="M12 2v4M12 18v4M4.93 4.93l2.83 2.83M16.24 16.24l2.83 2.83"/></svg>
        </div>
        ...
        <div style="font-family:var(--font-display);font-size:clamp(22px,2.5vw,30px);line-height:1;letter-spacing:0.02em;color:var(--ink);margin-bottom:10px;">THE NAVIGATION</div>
        <p style="font-size:13px;color:var(--muted-2);line-height:1.65;">Reads what the wearable sees. Understands what you are fuelling it with. Translates both into one clear direction — so you stop guessing and start performing.</p>
      </div>

    </div>
    <p style="text-align:center;font-size:clamp(14px,1.4vw,17px);font-weight:300;color:var(--muted-2);max-width:600px;margin:40px auto 0;line-height:1.8;" class="reveal d2">Your wearable has been recording data for months. Your meals contain signals nobody has decoded yet. In isolation, neither tells you much. Connected, they change everything. That is the engine TLC builds for you.</p>
  </div>
</section>
  ...
  <div class="container">
    ...
    <div class="pillars-grid">
      <div class="pillar-card nutrition reveal d1">
        <div class="pillar-visual"><div class="pillar-icon-wrap"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#39BA76" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2a10 10 0 100 20 10 10 0 000-20z"/><path d="M12 6v6l4 2"/><path d="M8 14s1.5 2 4 2 4-2 4-2"/></svg></div></div>
        <h3>Nutrition</h3>
      ...
      <div class="pillar-card body-pillar reveal d2">
        <div class="pillar-visual"><div class="pillar-icon-wrap"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#398CBA" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg></div></div>
        <h3>Body</h3>
      ...
      <div class="pillar-card mind reveal d3">
        <div class="pillar-visual"><div class="pillar-icon-wrap"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#E8B84B" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg></div></div>
        <h3>Mind</h3>
