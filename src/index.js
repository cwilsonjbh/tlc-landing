...
.s-loop { padding: var(--section-pad) 0; background: var(--ink); position: relative; z-index: 2; overflow: hidden; }
.loop-hdr { text-align: center; margin-bottom: 48px; }
.loop-hdr h2 { font-family: var(--font-display); font-size: clamp(36px, 5vw, 60px); line-height: 1; letter-spacing: 0.02em; color: var(--white); margin-bottom: 14px; }
.loop-hdr h2 em { font-style: normal; color: var(--green-accent, #46c461); }
.loop-hdr > p { font-size: 16px; color: rgba(255,255,255,0.5); max-width: 460px; margin: 0 auto; line-height: 1.7; }
