...
<section class="hero" id="hero">
  <div class="hero-left">
    ...
    <p class="hero-body">TLC reads your meals, your wearable data, and how you actually feel. Then it joins the dots between all three to show you what none of them could show you alone. Every day, a single insight that makes the invisible visible.</p>
