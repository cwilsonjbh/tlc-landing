...
<section class="hero" id="hero">
  <div class="hero-left">
    ...
    <h1 class="hero-headline" style="font-size:clamp(58px,7.5vw,112px);">YOUR MIND KNEW.<br>YOUR BODY KNEW.<br>YOUR WEARABLE KNEW.</h1>
    <span class="hero-headline-green">Nobody connected them. Until now.</span>
    <p class="hero-body">TLC reads your meals, your wearable data, and how you actually feel — then joins the dots between all three to show you what none of them could show you alone. Every day, a single insight that makes the invisible visible.</p>
